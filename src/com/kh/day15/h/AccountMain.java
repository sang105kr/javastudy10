...
public class AccountMain {
  ...
  public static Account[] accounts;               //계좌를 담는 배열
  ...
  public static void main(String[] args) {
    ...
    while (!stop) {
      ...
      int findedIndex = NOT_FOUND;         // 인덱스번호 : 없으면 -1
...
//              System.out.println("계좌 계설 한도 5구좌가 모두 찼습니다.");
//              continue;
//            }
            //2) 동명이인 체크
...
//            }
  ...
  private static int findIndexOfAccount(String accountNumber) {
    ...
    throw new RuntimeException("찾고자하는 계좌가 없습니다");
    //return NOT_FOUND;
  }
  ...
  private static int findNullIndex() {
    for (int i = 0; i < accounts.length; i++) {
      if(accounts[i] == null){
        return i;
      }
    }
    throw new RuntimeException("계좌 계설 한도 5구좌가 모두 찼습니다.");
    //return -1;
  }
}
