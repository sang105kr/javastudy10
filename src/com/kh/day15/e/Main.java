...
import com.kh.day15.e.UserException1;
...
//    }
  ...
  static void deposit(int money) {
    if (money > 40_000) {
//      throw new RuntimeException("1회 입금은 4만원을 초과할 수 없습니다");
      throw new UserException1("1회 입금은 4만원을 초과할 수 없습니다");
    }
    if (money < 1) {
//      throw new RuntimeException("1원보다 작은 금액을 입금할수 없습니다.");
      throw new UserException2("1원보다 작은 금액을 입금할수 없습니다.");
    }
  }
}
